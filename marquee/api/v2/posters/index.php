...
// under api/, or under marquee/api/v1/. Where this endpoint needs the same provider
// integration as another, the code is duplicated on purpose — sharing it would
// couple them and put an endpoint that serves deployed clients at risk.
//
// v2 differs from v1 in one respect: TVmaze is a fourth source. The request
// contract is unchanged, so a client upgrades by changing the path alone.
...
require_once __DIR__ . '/../lib/tvmaze.php';
